        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" wire:model="username">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fname" type="text" class="form-control @error('fname') is-invalid @enderror" wire:model="fname">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lname" type="text" class="form-control @error('lname') is-invalid @enderror" wire:model="lname">
                ...
                <div class="modal-footer">
                    ...
                    @if($editMode)
                    <button type="button" class="btn btn-success" wire:click="updateUser()">Update</button>
                    @else
